        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#demo" className="hover:text-orange-500 transition-colors">Demo</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/status" className="hover:text-orange-500 transition-colors">Status</Link></li>
            </ul>
          </div>
        </div>

        ...
        <div className="bg-zinc-800 border border-gray-700 rounded-2xl p-8 text-center">
          ...
          {status === 'error' && (
            <div className="space-y-3">
              <Link href="/login" className="block w-full px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg text-sm font-medium transition-colors">
                Back to Login
              </Link>
              <Link href="/" className="block w-full px-4 py-2 bg-zinc-700 hover:bg-zinc-600 text-white rounded-lg text-sm font-medium transition-colors">
                Go Home
              </Link>
            </div>
          )}
